...
As we discussed the last two weeks, these are actually regressions with no slope. Thus, model one has two free parameters:
...
a2 <- load.rjmcmc('relaxedBM.tqxklewgt')
```
